...
const CarDetails = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://tranquil-ocean-72322.herokuapp.com/addOrders", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    fetch(`https://tranquil-ocean-72322.herokuapp.com/singleCar/${carId}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div className="container">
      ...
      <h4 className=" mb-5" >For purchase your car fill up the form and comform your booking</h4>
